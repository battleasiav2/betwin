    ...
    <div class="user-card">
        ...
        <div style="margin-top: 24px;">
            <div style="display: flex; align-items: center; gap: 8px;">
                <span style="font-size: 30px; font-weight: 900; color: #e8b84a;">
                    ৳ {{ number_format(auth()->user()->balance, 2) }}
                </span>
                <i class="fas fa-sync-alt" style="color:#8b97a8; font-size:14px; cursor:pointer;" onclick="location.reload()"></i>
            </div>
        </div>
