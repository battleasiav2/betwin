...
<footer class="footer-area" style="position: relative; background: #123B66; margin-top: 0; padding-top: 0;">
    ...
    <div style="width: 100%; height: 2px; background: linear-gradient(90deg, transparent, #2563eb, transparent); margin-bottom: 20px;"></div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col ps-3">
                    ...
                    <div class="footer-social-row" aria-label="BET369WIN contact">
                        ...
                        <a class="footer-social--support" href="{{ auth()->check() ? route('ticket.index') : route('contact') }}" title="Support" aria-label="Support">
