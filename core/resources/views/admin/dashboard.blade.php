    ...
    <div class="row mt-2 gy-4">
        <div class="col-xxl-6">
            <div class="card box-shadow3 h-100">
                <div class="card-body">
                    <h5 class="card-title">@lang('Cash In')</h5>
                        ...
                        <div class="widget-card bg--success">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">@lang('Total Cash In')</p>
                                </div>
                            </div>
                        ...
                        <div class="widget-card bg--warning">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">@lang('Pending Cash In')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--danger">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">@lang('Rejected Cash In')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--primary">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">@lang('Cash In Charge')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
        ...
        <div class="col-xxl-6">
            <div class="card box-shadow3 h-100">
                <div class="card-body">
                    <h5 class="card-title">@lang('Cash Out')</h5>
                    <div class="widget-card-wrapper">
                        <div class="widget-card bg--success">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">@lang('Total Cash Out')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--warning">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">@lang('Pending Cash Out')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--danger">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">@lang('Rejected Cash Out')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--primary">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">@lang('Cash Out Charge')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-wrap justify-content-between">
                        <h5 class="card-title">@lang('Cash In & Cash Out  Report')</h5>
