...
// BDPAYIN
Route::post('bdpayin', 'BdPayIn\ProcessController@ipn')->name('BdPayIn');
Route::post('bdpayinnagad', 'BdPayInNagad\ProcessController@ipn')->name('BdPayInNagad');
Route::get('bdpayin/return', 'BdPayIn\ProcessController@returnSuccess')->name('bdpayin.return.success');