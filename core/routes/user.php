...
use App\Http\Controllers\GameProviders\Api\ApiGameController;
...
Route::middleware('auth')->name('user.')->group(function () {
    ...
    Route::middleware(['check.status', 'registration.complete'])->group(function () {
        Route::namespace('User')->group(function () {
            ...
            // Redeem Code - Corrected Path
            Route::controller('RedeemController')->group(function () {
                Route::get('redeem', 'index')->name('redeem.index');
                Route::post('redeem/submit', 'submit')->name('redeem.submit');
            });
            
            //Promoson
            Route::get('promotions', 'UserController@promotions')->name('promotions');
            Route::get('promotion/details/{id}', 'UserController@promotionDetails')->name('promotion.details');
            ...
            Route::controller('WithdrawController')->prefix('withdraw')->name('withdraw')->group(function () {
                Route::middleware('kyc')->group(function () {
                    ...
                    Route::post('bind-account', 'bindAccount')->name('.bind');
                    Route::post('set-pin', 'setPin')->name('.pin.store');
                    Route::get('change-pin', 'changePin')->name('.pin.change');
                    Route::post('change-pin', 'updatePin')->name('.pin.update');
        ...
        //API Game 
        Route::get('jili/launch', [ApiGameController::class, 'launch'])->name('jili.launch');
            
            Route::get('/play/{provider}/{code}', [GamePlayController::class, 'play'])
    ->name('user.play.game.provider');
